...
public class Account {
  ...
  public Pair<Account, Account> transferTo(Account toAccount, double amount) {
    Account to = toAccount.deposit(amount);
    Account current = this.withdraw(amount);
    return new Pair<>(current, to);
  }
  ...
  public Account combine(Account other) {
    ...
    Customer[] newOwners = concat(this.owners, other.owners);
    return new Account(this.accountNumber, newBalance,
        this.isClosed, newOwners);
  }
