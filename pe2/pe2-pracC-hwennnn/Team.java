...
public class Team {
  ...
  public Team score(double points) {
    return new Team(this.teamID, this.points + points,
        this.isDisqualified, this.members);
  }
  ...
  public Pair<Team, Team> transferTo(Team toTeam, double points) {
    Team curr = this.penalize(points);
    Team newToTeam = toTeam.score(points);
    return new Pair<>(curr, newToTeam);
  }
  ...
  public Team mergeWith(Team other) {
    return new Team(this.teamID, this.points + other.points,
        this.isDisqualified, concat(this.members, other.members));
  }
  ...
  public Team disqualify() {
    return new Team(this.teamID, this.points, true, this.members);
  }
